...
<body>
    ...
    <div style="margin: 30px 0; max-width: 500px;">
        <form method="POST">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <?php if ($user['userRole'] === 'Donor'): ?>
                    <select id="eligibilityStatus"
                            ...
                            required>
                        <option value="Valid" <?= $user['eligibilityStatus'] === 'Valid' ? 'selected' : '' ?>>
                            Valid
                        </option>
                        <option value="Invalid" <?= $user['eligibilityStatus'] === 'Invalid' ? 'selected' : '' ?>>
                            Invalid
                        </option>
                    </select>
                <?php else: ?>
                    ...
                    <input type="hidden"
                        name="eligibilityStatus"
                        value="<?= htmlspecialchars($user['eligibilityStatus']) ?>">
                <?php endif; ?>
            </div>
            ...
            <button type="button" onclick="window.location.href='manageUsers.php'">
                Cancel
            </button>
        </form>
    </div>
